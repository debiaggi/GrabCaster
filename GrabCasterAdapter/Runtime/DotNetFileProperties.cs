...
namespace Microsoft.BizTalk.SDKSamples.Adapters
{
    ...
    /// </summary>
    internal abstract class GrabCasterCommonProperties : ConfigProperties
    {
        ...
        public GrabCasterCommonProperties ()
        {
        }
    ...
    /// </summary>
    internal class GrabCasterReceiveProperties : GrabCasterCommonProperties
    {
		// Handler properties
        ...
        public GrabCasterReceiveProperties () : base()
        {
            ...
            maximumBatchSize     = 0;
            this.maximumNumberOfMessages = handlerMaximumNumberOfFiles; // default to handler value, override if set on the endpoint
		...
		public override void ReadLocationConfiguration (XmlDocument configDOM)
        {
			...
			this.maximumNumberOfMessages = IfExistsExtractInt(configDOM, "/Config/maximumNumberOfFiles", handlerMaximumNumberOfFiles);
	...
	/// </summary>
    internal class GrabCasterTransmitProperties : GrabCasterCommonProperties
    {
		// Handler properties
