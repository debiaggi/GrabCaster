...
You can communicate your ideas trough the [contact form](http://grabcaster.com/grabcaster-contact/) or adding a [new issue](https://github.com/GrabCaster/GrabCaster.Framework/issues) in GitHub.

## Getting started

* Pick an [issue](https://github.com/GrabCaster/GrabCaster.Framework/issues) you're interested in doing,
  or something that you feel is missing.
* Send a "pull request".

## Create a pull request

* Fork GrabCaster, refer to [Fork A Repository in the GitHub documentation](https://help.github.com/articles/fork-a-repo/) for more information.
